---
title: "Introduction to data - KEY"
...
<ol>
<li> Mean would be more reliable as it gives us the true average. **- CORRECT ANSWER**</li> 
...
`dep_type` with levels `"on time"` and `"delayed"` depending on whether there was ny 
departure delay. Then, determine the on time arrival percentage based on whether the 
flight departed on time or not. What percent of flights that were `"delayed"` 
departing arrive `"on time"`? 
**CORRECT NUMERIC INPUT: 0.27**
